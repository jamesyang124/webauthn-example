...
func HandleWebAuthnOptions(db *sql.DB, logger *log.Logger) func(*fasthttp.RequestCtx) {
...
func HandleVerification(ctx *fasthttp.RequestCtx, db *sql.DB, logger *log.Logger) {
